...
$TeamLang = array(
  ...
  'WebClientTeam'		=> 'Web Team Editor',
  'WebRosterEditor' => 'Web Roster Editor',
  'WebLinesEditor' => 'Pro Lines Editor',
  'WebLinesEditor' => 'Farm Lines Editor',
  ...
  'Equipe actuelle' => 'Current team',
  'Date de naissance' => 'Birthday',
  'Annee de contrat | Salaire' => 'Year of contract | Salary',
  'Recrue' => 'Rookie',
  'Disponible pour echange' => 'Available for trade',
  'Annee de repêchage | Rang' => 'DraftYear | Rank',
  'Condition | Blessure' => 'Condition | Injury',
  'LinesEditor' => 'Lines Editor'
);

$InjuryLang = array(
  'Right Forearm Injury' => 'Right Forearm Injury',
  'Right Hip Injury' => 'Right Hip Injury',
  'Left Leg Injury' => 'Left Leg Injury',
  'Bruised Right Foot Injury' => 'Bruised Right Foot Injury',
  'Bruised Right Arm Injury' => 'Bruised Right Arm Injury',
  'Upper Body Injury' => 'Upper Body Injury',
  'Torn Left ACL Injury' => 'Torn Left ACL Injury',
  'Broken Bone (Right Arm) Injury' => 'Broken Bone (Right Arm) Injury',
  'Fractured Right Foot Injury' => 'Fractured Right Foot Injury',
  'Right Leg Injury' => 'Right Leg Injury',
  'Strained Back Injury' => 'Strained Back Injury',
  'Broken Left Foot Toe Injury' => 'Broken Left Foot Toe Injury',
  'Fractured Metatarsal (Right Foot) Injury' => 'Fractured Metatarsal (Right Foot) Injury',
  'Right Foot Injury' => 'Right Foot Injury',
  'Fractured Orbital Bone Injury' => 'Fractured Orbital Bone Injury',
  'Left Knee Injury' => 'Left Knee Injury',

  'Bruised Left Foot Injury' => 'Bruised Left Foot Injury',
  'Broken Bone (Right Ankle) Injury' => 'Broken Bone (Right Ankle) Injury',
  'Left Hand Injury' => 'Left Hand Injury',
  'Torso Injury' => 'Torso Injury',
  'Sports Hernia Injury' => 'Sports Hernia Injury',
  'Bruised Left Arm Injury' => 'Bruised Left Arm Injury',
  'Right Knee Injury' => 'Right Knee Injury',
  'Broken Bone (Left Arm) Injury' => 'Broken Bone (Left Arm) Injury',
  'Fractured Left Foot Injury' => 'Fractured Left Foot Injury',
  'Right Wrist Injury' => 'Right Wrist Injury',
  'Separated Left Shoulder Injury' => 'Separated Left Shoulder Injury',
  'Separated Right Shoulder Injury' => 'Separated Right Shoulder Injury',
  'Head Injury' => 'Head Injury',
  'Fractured Bone in Left Hand Injury' => 'Fractured Bone in Left Hand Injury',
  'Sore Right Knee Injury' => 'Sore Right Knee Injury',
  'Broken Left Index Finger Injury' => 'Broken Left Index Finger Injury',
  'Torn Right Knee Ligaments Injury' => 'Broken Left Index Finger Injury',
  'Right Eye Injury' => 'Right Eye Injury',
  'Left Eye Injury' =>  'Left Eye Injury',
