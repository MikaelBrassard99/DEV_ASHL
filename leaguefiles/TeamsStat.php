...
if (file_exists($DatabaseFile) == false) {
	...
	if (isset($_GET['Order'])) {
		$OrderByInput  = filter_var($_GET['Order'], FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_LOW || FILTER_FLAG_STRIP_HIGH || FILTER_FLAG_NO_ENCODE_QUOTES || FILTER_FLAG_STRIP_BACKTICK);
	}
	if (isset($_GET['Season'])) {
		$TypeText = $TypeText . "Season";
	}
...
<body>
	...
	<table class="tablesorter STHSPHPTeamsStat_Table">
		<thead>
			<tr>
