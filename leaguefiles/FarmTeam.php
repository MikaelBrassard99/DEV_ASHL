...
try {
	...
	if ($Team == 0 and $CookieTeamNumber > 0 and $CookieTeamNumber <= 100) {
		$Team = $CookieTeamNumber;
	} // If no team in URL, check the Cookie Team Number and show this Team
	if ($Team == 0 or $Team > 100) {
		...
		if ($Result['count'] == 1) {
			if (isset($PerformanceMonitorStart)) {
				echo "<script>console.log(\"STHS Query Start Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
			}
			...
			if (file_exists($CareerStatDatabaseFile) == true and $LeagueOutputOption['SeparateCareerStatFromTeamPage'] == "False") { /* CareerStat */
				if (isset($PerformanceMonitorStart)) {
					echo "<script>console.log(\"STHS CareerStat Start Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
				}
				...
				if (isset($PerformanceMonitorStart)) {
					echo "<script>console.log(\"STHS CareerStat End Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
				}
			} else {
				$TeamCareerSeason = Null;
				$TeamCareerPlayoff = Null;
...
if (isset($PerformanceMonitorStart)) {
	echo "<script>console.log(\"STHS Header Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
}
?>
<style>
	<?php
...
<body>
	...
	<div id="STHSPHPTeamStat_SubHeader">
		...
		if ($TeamInfo <> Null) {
			...
			echo "<img src=\"./images/Farm-team/" . $TeamInfo['UniqueID'] . ".png\" alt=\"\" class=\"STHSPHPTeamStatImage \" />";
	...
	<div class="STHSPHPTeamStat_Main">
		...
		<div class="tabsmain standard">
			<ul class="tabmain-links">
				<li><a class="tabmenuhome" <?php echo "href=\"ProTeam.php?Team=" . $Team . "\">";
											if ($TeamProInfo != Null) {
												echo $TeamProInfo['Name'];
											} ?></a></li>
				<li<?php if ($SubMenu == 0) {
										...
										<li<?php if ($SubMenu == 6) {
											...
											<!-- <li<?php if ($SubMenu == 7) {
												...
												if ($TeamCareerStatFound == true) {
													...
													echo "><a href=\"#tabmain8\">" . $TeamLang['CareerTeamStat'] . "</a></li>\n";
												}
												if ($LeagueOutputOption != Null) {
													if (file_exists($CareerStatDatabaseFile) == true and $LeagueOutputOption['SeparateCareerStatFromTeamPage'] == "True") {
														echo "<li><a class=\"tabmenuhome\" href=\"TeamCareerOnly.php?Team=" . $Team . "&Farm\">" . $TeamLang['CareerTeamStat'] . "</a></li>\n";
													}
												}
												if ($LeagueOutputOption != Null) {
													if ($LeagueOutputOption['ShowWebClientInDymanicWebsite'] == "True" and ($DoNotRequiredLoginDynamicWebsite == True or $CookieTeamNumber == $Team)) {
			...
			<div style="border-radius:1px;box-shadow:-1px 1px 1px rgba(0,0,0,0.15);border-style: solid;border-color: #dedede">
				...
				<div class="tabmain<?php if ($SubMenu == 0) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 0 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
						...
						<tr>
							...
							<td class="STHSPHPPlayerStat_HomeLeftTD">
								...
								if ($TeamInfo <> Null) {
									...
									echo "<tr><td rowspan=\"3\"><img src=\"" . $ImagesCDNPath . "/leaguefiles/images/ArenaInfo.png\" alt=\"\" class=\"STHSPHPTeam_HomeSecondaryTableImage\"></td>";
									...
									echo "<tr><td rowspan=\"4\"><img src=\"" . $ImagesCDNPath . "/leaguefiles/images/RosterInfo.png\" alt=\"\" class=\"STHSPHPTeam_HomeSecondaryTableImage\"></td>";
									...
									if ($TeamCareerStatFound == true) {
										...
										echo "<tr><td rowspan=\"5\"><img src=\"" . $ImagesCDNPath . "/leaguefiles/images/Stats.png\" alt=\"\" class=\"STHSPHPTeam_HomeSecondaryTableImage\"></td>";
				...
				<div class="tabmain<?php if ($SubMenu == 1) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 1 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
				...
				<div class="tabmain<?php if ($SubMenu == 2) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 2 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
							...
							<tr>
								...
								if ($GoalieStatTeam != Null) {
									if ($GoalieStatTeam['SumOfGP'] > 0) {
										...
										echo "<td>";
										if ($GoalieStatTeam['SumOfPenalityShotsPCT'] <> Null) {
											number_Format($GoalieStatTeam['SumOfPenalityShotsPCT'], 3);
										};
										echo "</td>";
					...
					if (file_exists($DatabaseFile) == false) {
						...
						if ($CookieTeamNumber > 0 and $CookieTeamNumber <= 100) {
							...
							if ($Team > 0 and $Team < 100 and $LeagueFinance['SalaryCapOption'] > 0) {
								...
								$Query = "SELECT MainTable.* FROM (SELECT PlayerInfo.Number, PlayerInfo.Name, PlayerInfo.Team, PlayerInfo.TeamName, PlayerInfo.ProTeamName, PlayerInfo.Age, PlayerInfo.AgeDate, PlayerInfo.Contract, PlayerInfo.Rookie, PlayerInfo.NoTrade, PlayerInfo.CanPlayPro, PlayerInfo.CanPlayFarm, PlayerInfo.ForceWaiver, PlayerInfo.WaiverPossible, PlayerInfo.ExcludeSalaryCap, PlayerInfo.ProSalaryinFarm, PlayerInfo.SalaryAverage, PlayerInfo.Salary1, PlayerInfo.Salary2, PlayerInfo.Salary3, PlayerInfo.Salary4, PlayerInfo.Salary5, PlayerInfo.Salary6, PlayerInfo.Salary7, PlayerInfo.Salary8, PlayerInfo.Salary9, PlayerInfo.Salary10, PlayerInfo.SalaryRemaining, PlayerInfo.SalaryAverageRemaining, PlayerInfo.SalaryCap, PlayerInfo.SalaryCapRemaining, PlayerInfo.Condition, PlayerInfo.Status1, PlayerInfo.URLLink, PlayerInfo.NHLID, PlayerInfo.PProtected,PlayerInfo.PosC, PlayerInfo.PosLW, PlayerInfo.PosRW, PlayerInfo.PosD, 'False' AS PosG, PlayerInfo.Retire as Retire FROM PlayerInfo WHERE " . $TeamQuery . " AND Retire = 'False' AND Status1 <= 1 UNION ALL SELECT GoalerInfo.Number +10000, GoalerInfo.Name, GoalerInfo.Team, GoalerInfo.TeamName, GoalerInfo.ProTeamName, GoalerInfo.Age, GoalerInfo.AgeDate, GoalerInfo.Contract, GoalerInfo.Rookie, GoalerInfo.NoTrade, GoalerInfo.CanPlayPro, GoalerInfo.CanPlayFarm, GoalerInfo.ForceWaiver, GoalerInfo.WaiverPossible, GoalerInfo.ExcludeSalaryCap, GoalerInfo.ProSalaryinFarm, GoalerInfo.SalaryAverage, GoalerInfo.Salary1, GoalerInfo.Salary2, GoalerInfo.Salary3, GoalerInfo.Salary4, GoalerInfo.Salary5, GoalerInfo.Salary6, GoalerInfo.Salary7, GoalerInfo.Salary8, GoalerInfo.Salary9, GoalerInfo.Salary10, GoalerInfo.SalaryRemaining, GoalerInfo.SalaryAverageRemaining, GoalerInfo.SalaryCap, GoalerInfo.SalaryCapRemaining, GoalerInfo.Condition, GoalerInfo.Status1, GoalerInfo.URLLink, GoalerInfo.NHLID, GoalerInfo.PProtected,'False' AS PosC, 'False' AS PosLW, 'False' AS PosRW, 'False' AS PosD, 'True' AS PosG, GoalerInfo.Retire as Retire FROM GoalerInfo WHERE " . $TeamQuery . " AND Retire = 'False' AND Status1 <= 1) AS MainTable ORDER BY PosG ASC, PosD ASC, Name ASC";
														$PlayerSalaryCap = $db->query($Query);

							$Query = "SELECT MainTable.* FROM (SELECT PlayerInfo.Number, PlayerInfo.Name, PlayerInfo.Team, PlayerInfo.ProTeamName, PlayerInfo.Status1, PlayerInfo.Retire as Retire FROM PlayerInfo WHERE Retire = 'False' AND Status1 <= 1 AND Contract > 0 AND Team > 0 UNION ALL SELECT GoalerInfo.Number + 10000, GoalerInfo.Name, GoalerInfo.Team, GoalerInfo.ProTeamName, GoalerInfo.Status1, GoalerInfo.Retire as Retire FROM GoalerInfo WHERE Retire = 'False' AND Status1 <= 1 AND Contract > 0 and Team > 0) AS MainTable ORDER BY Name ASC";
				...
				<div class="tabmain<?php if ($SubMenu == 4) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 4 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
					<br />
					...
					<table class="STHSPHPTeamStat_Table">
						...
						<tr>
							...
							<th class="STHSW25"><?php echo $TeamLang['TimePCT']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PHY']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['DF']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['OF']; ?></th>
						</tr>
				...
				<div class="tabmain<?php if ($SubMenu == 5) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 5 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
				...
				<div class="tabmain<?php if ($SubMenu == 6) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 6 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
				...
				<div class="tabmain<?php if ($SubMenu == 7) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 7 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
					<br />
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="3"><?php echo $TeamLang['ArenaCapacityTicketPriceAttendance']; ?></th>
						</tr>
						<tr>
						...
						if ($TeamFinance != Null) {
							...
							if ($TeamStat['HomeGP'] > 0) {
								echo "<tr><th>" . $TeamLang['Attendance'] . "</th><td>" . number_Format($TeamFinance['AttendanceL1'], 0) . "</td><td>" . number_Format($TeamFinance['AttendanceL2'], 0) . "</td></tr>\n";
							} else {
								echo "<tr><th>" . $TeamLang['Attendance'] . "</th><td>0%</td><td>0%</td></tr>\n";
							}
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="4"><?php echo $TeamLang['Expenses']; ?></th>
						</tr>
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['YearToDateExpenses']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['PlayersTotalSalaries']; ?></th>
				...
				<div class="tabmain<?php if ($SubMenu == 8) {
					...
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 8 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
					<br />
					...
					<table class="tablesorter STHSPHPTeam_TeamCareerPlayersSeasonTop5">
						<thead>
							<tr>
								<?php $InputJson = $TeamCareerPlayersSeasonTop5;
								include "HistorySubForPlayerStat.php"; ?>

								<br />
								<h1><?php echo $TeamName . $TeamLang['CareerGoaliesLeaderSeason']; ?></h1>
								<div class="tablesorter_ColumnSelectorWrapper">
								...
								<table class="tablesorter STHSPHPTeam_TeamCareerGoaliesSeasonTop5">
									<thead>
										<tr>
											<?php
											...
											<br />
											<h1><?php echo $TeamName . $TeamLang['CareerTeamStats']; ?></h1>
											<div class="tablesorter_ColumnSelectorWrapper">
											...
											<table class="tablesorter STHSPHPTeam_TeamCareerStat">
												<thead>
													<tr>
														...
														<th class="sorter-false" colspan="11"><?php echo $TeamLang['Overall']; ?></th>
														<th class="sorter-false" colspan="11"><?php echo $TeamLang['Home']; ?></th>
												...
												<tbody>
													...
													if ($TeamCareerSumSeasonOnly != Null) {
														...
														if (empty($TeamCareerSeason) == false) {
															foreach ($TeamCareerSeason as $row) {
																if ($row['GP'] > 0) {
													...
													if ($TeamCareerSumPlayoffOnly != Null) {
														...
														if (empty($TeamCareerPlayoff) == false) {
															foreach ($TeamCareerPlayoff as $row) {
																if ($row['GP'] > 0) {
																	echo "<tr><td>" . $row['Year'] . "</td>";
																	include "HistorySubForTeamStat.php";
																}
											...
											<table class="tablesorter STHSPHPTeam_TeamCareerPlayersPlayoffTop5">
												<thead>
													<tr>
														<?php $InputJson = $TeamCareerPlayersPlayoffTop5;
														include "HistorySubForPlayerStat.php"; ?>

														<br />
														<h1><?php echo $TeamName . $TeamLang['CareerGoaliesLeaderPlayoff']; ?></h1>
														<div class="tablesorter_ColumnSelectorWrapper">
														...
														<table class="tablesorter STHSPHPTeam_TeamCareerGoaliesPlayoffTop5">
															<thead>
																<tr>
																	<?php $InputJson = $TeamCareerGoaliesPlayoffTop5;
																	include "HistorySubForGoalieStat.php"; ?>
																	<br /><br />
				</div>
