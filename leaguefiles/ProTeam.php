...
if (isset($_GET['Team'])) {
	$Team = filter_var($_GET['Team'], FILTER_SANITIZE_NUMBER_INT);
}
$SubMenu = 0;
if (isset($_GET['SubMenu'])) {
	$SubMenu = filter_var($_GET['SubMenu'], FILTER_SANITIZE_NUMBER_INT);
}
if ($SubMenu < 0 or $SubMenu > 12) {
	$SubMenu = 0;
}
...
if ($Team == 0 or $Team > 100) {
	...
	if ($Result['count'] == 1) {
		...
		if ($LeagueOutputOption['MergeProFarmRoster'] == "False") {
		} else {
	...
	<div id="STHSPHPTeamStat_SubHeader">
	   ...
	   //echo $TeamInfo['TeamThemeID'];
		   ...
		   echo $TeamInfo['TeamThemeID'];
			...
			echo " | PK%: ";
			if ($TeamStat['PKAttemp'] > 0) {
				echo number_Format(($TeamStat['PKAttemp'] - $TeamStat['PKGoalGA']) / $TeamStat['PKAttemp'] * 100, 2) . "%";
			} else {
				echo "0.00%";
			}
		...
		<div class="tabsmain standard">
			<ul class="tabmain-links">
				...
				<li<?php if ($SubMenu == 0) {
					...
					} ?>><a href="#tabmain0"><?php echo $TeamLang['Home']; ?></a></li>
					<li<?php if ($SubMenu == 1) {
							echo " class=\"activemain\"";
						} ?>><a href="#tabmain1"><?php echo $TeamLang['Roster']; ?></a></li>
						<li<?php if ($SubMenu == 2) {
								echo " class=\"activemain\"";
							} ?>><a href="#tabmain2"><?php echo $TeamLang['Scoring']; ?></a></li>
							<li<?php if ($SubMenu == 3) {
									echo " class=\"activemain\"";
								...
								<li<?php if ($SubMenu == 5) {
									...
									<li<?php if ($SubMenu == 6) {
											echo " class=\"activemain\"";
										} ?>><a href="#tabmain6"><?php echo $TeamLang['Schedule']; ?></a></li>
										<!-- <li<?php if ($SubMenu == 7) {
													echo " class=\"activemain\"";
												} ?>><a href="#tabmain7"><?php echo $TeamLang['Finance']; ?></a></li> -->
										<li<?php if ($SubMenu == 8) {
												echo " class=\"activemain\"";
											} ?>><a href="#tabmain8"><?php echo $TeamLang['Depth']; ?></a></li>
											<!-- <li<?php if ($SubMenu == 13) {
														echo " class=\"activemain\"";
													} ?>><a href="#tabmain13"><?php echo $TeamLang['News']; ?></a></li> -->
											<li<?php if ($SubMenu == 9) {
													echo " class=\"activemain\"";
												} ?>><a href="#tabmain9"><?php echo $TeamLang['History']; ?></a></li>
			...
			<div style="border-radius:1px;box-shadow:-1px 1px 1px rgba(0,0,0,0.15);border-style: solid;border-color: #dedede">
				...
				<div class="tabmain<?php if ($SubMenu == 0) {
										echo " active";
									} ?>" id="tabmain0">
					<div style="overflow-x:auto;">
						<table class="STHSPHPTeam_HomeTable">
							<tr>
								<td class="STHSPHPPlayerStat_HomeMainTD">
									<?php
									$LoopCount = (int) 0;
									if (empty($ScheduleLastGame) == false) {
										while ($row = $ScheduleLastGame->fetchArray()) {
											$LoopCount += 1;
											echo "<table class=\"STHSPHPTeam_HomePrimaryTable\">";
											if ($LoopCount == 1) {
												echo "<tr><td colspan=\"7\" class=\"STHSPHPTeamStat_TableTitle\">" . $TeamLang['GameCenter'] . "</td></tr>";
											}
											echo "<tr onclick=\"Game" . $LoopCount . "()\"><td class=\"STHSPHPTeam_HomePrimaryTableTeamImag\">\n";
											echo "<img src=\"./images/Pro-team/" . $row['VisitorTeam'] . ".png\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableTeamImageSpec\" />\n";
											...
											echo "<img src=\"./images/Pro-team/" . $row['HomeTeam'] . ".png\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableTeamImageSpec\" />\n";
											echo "</td></tr></table>\n";

											echo "<table class=\"STHSPHPTeam_HomeTeamStatTable\" id=\"Game" . $LoopCount . "\"><tr><th colspan=\"2\" >Team Stats</th></tr>\n";
											...
											echo "<tr><td class=\"STHSPHPTeam_HomeTeamStatR\">";
											if ($row['VPKAttemp'] > 0) {
												echo number_Format(($row['VPKAttemp'] - $row['VPKGA']) / $row['VPKAttemp'] * 100, 2) . "%";
											} else {
												echo "0%";
											}
											echo "</td><td class=\"STHSPHPTeam_HomeTeamStatC\">" . $TeamLang['PenaltyKillPercentage'] . "</td><td class=\"STHSPHPTeam_HomeTeamStatL\">";
											if ($row['HPKAttemp'] > 0) {
												echo number_Format(($row['HPKAttemp'] - $row['HPKGA']) / $row['HPKAttemp'] * 100, 2) . "%";
											} else {
												echo "0%";
											}
											echo "</td></tr>\n";
									...
									if (empty($ScheduleNextGame) == false) {
										while ($row = $ScheduleNextGame->fetchArray()) {
											$LoopCount += 1;
									...
									<table style="width:100%;border-collapse:collapse">
										...
										<tr>
											<td colspan="5" class="STHSPHPTeamStat_TableTitle" style="padding:10px"><?php echo $TeamLang['TeamLeaders']; ?></td>
										</tr>
										<tr>
											<?php
											$ResultBound = False;
											if (empty($TeamLeaderG) == false) {
												while ($Row = $TeamLeaderG->fetchArray()) {
											...
											<?php
											if (empty($TeamLeaderA) == false) {
												while ($Row = $TeamLeaderA->fetchArray()) {
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshotTD\">";
													echo "<img loading=\"lazy\" src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer($Row['Name']) . "&width=136&height=136\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshot\"/>";
										...
										<tr>
											<?php
											$ResultBound = False;
											if (empty($TeamLeaderP) == false) {
												while ($Row = $TeamLeaderP->fetchArray()) {
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshotTD\">";
													echo "<img loading=\"lazy\" src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer($Row['Name']) . "&width=136&height=136\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshot\"/>";
											...
											<td style="width:20px"></td>
											<?php
											if (empty($TeamLeaderPlusMinus) == false) {
												while ($Row = $TeamLeaderPlusMinus->fetchArray()) {
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshotTD\">";
													echo "<img loading=\"lazy\" src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer($Row['Name']) . "&width=136&height=136\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshot\"/>";
										...
										<tr>
											<?php
											$ResultBound = False;
											if (empty($TeamLeaderGAA) == false) {
												while ($Row = $TeamLeaderGAA->fetchArray()) {
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshotTD\">";
													echo "<img loading=\"lazy\" src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer($Row['Name']) . "&width=136&height=136\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshot\"/>";
											...
											if (empty($TeamLeaderSavePCT) == false) {
												while ($Row = $TeamLeaderSavePCT->fetchArray()) {
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshotTD\">";
													echo "<img loading=\"lazy\" src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer($Row['Name']) . "&width=136&height=136\" alt=\"\" class=\"STHSPHPTeam_HomePrimaryTableLeadersHeadshot\"/>";
									...
									<table class="STHSPHPTeam_HomePrimaryTable" style="border-bottom-width:0px">
										<tr>
											<td colspan="4" class="STHSPHPTeamStat_TableTitle"><?php echo $TeamLang['TeamStats'] ?></td>
										</tr>
										<tr>
											<?php if ($TeamStat != Null) {
												if ($TeamStat['GP'] > 0) {
													...
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableTeamStatTD\" style=\"border-bottom:1px solid #ddd;border-left:1px solid #ddd;\"><span>" . $TeamLang['PowerPlayPercentage'] . "</span><br><span class=\"STHSPHPTeam_HomePrimaryTableTeamStatStrongText\">";
													if ($TeamStat['PPAttemp'] > 0) {
														echo number_Format($TeamStat['PPGoal'] / $TeamStat['PPAttemp'] * 100, 1);
													} else {
														echo "0";
													}
													echo "%</span><br><span>" . ($TeamStat['PPGoal']) . "&nbsp;GF</span></td>\n";
													...
													echo "<td class=\"STHSPHPTeam_HomePrimaryTableTeamStatTD\" style=\"border-left:1px solid #ddd;\"><span>" . $TeamLang['PenaltyKillPercentage'] . "</span><br><span class=\"STHSPHPTeam_HomePrimaryTableTeamStatStrongText\">";
													if ($TeamStat['PKAttemp'] > 0) {
														echo number_Format(($TeamStat['PKAttemp'] - $TeamStat['PKGoalGA']) / $TeamStat['PKAttemp'] * 100, 1);
													} else {
														echo "0";
													}
													echo "%%</span><br><span>" . ($TeamStat['PKGoalGA']) . "&nbsp;GA</span></td>\n";
								...
								<td class="STHSPHPPlayerStat_HomeLeftTD">
									<?php
									if ($TeamInfo <> Null) {
										...
										if (empty($CoachInfo) == false) {
											echo "<tr><td>" . $TeamLang['Coach'] . "</td><td class=\"STHSPHPTeam_HomeSecondaryTableTDStrongText\">" . $CoachInfo['Name'] . "</td></tr>\n";
										}
										...
										echo "<tr><td>" . $TeamLang['Attendance'] . "</td><td class=\"STHSPHPTeam_HomeSecondaryTableTDStrongText\">";
										if ($TeamStat['HomeGP'] > 0) {
											echo number_Format($TeamFinance['TotalAttendance'] / $TeamStat['HomeGP']);
										};
										echo "</td></tr>\n";
										...
										if ($TeamCareerStatFound == true) {
											...
											if ($TeamCareerL > 0) {
												echo " (" . number_Format($TeamCareerW / ($TeamCareerW + $TeamCareerL + $TeamCareerT + $TeamCareerOTLSOL), 3) . "%)";
											}
											echo "</td></tr>\n";
				...
				<div class="tabmain<?php if ($SubMenu == 1) {
					...
					<div style="overflow-x:auto;">
						<table class="tablesorter STHSPHPTeam_PlayersRosterTable">
							<thead>
								<tr>
									...
									if ($TeamInfo <> Null) {
										...
										for ($Status = 3; $Status >= $LoopEnd; $Status--) {
											...
											if ($Status == 2) {
												echo "</tbody><tbody class=\"tablesorter-no-sort\"><tr><th colspan=\"" . $Colspan . "\">" . $TeamLang['Scratches'] . "</th></tr></tbody><tbody>";
												$LoopCount = (int) 0;
											}
											if ($Status == 1) {
												echo "</tbody><tbody class=\"tablesorter-no-sort\"><tr><th colspan=\"" . $Colspan . "\">" . $TeamLang['FarmTeam'] . "</th></tr></tbody><tbody>";
												$LoopCount = (int) 0;
											}
											...
											if (empty($PlayerRoster) == false) {
												while ($Row = $PlayerRoster->fetchArray()) {
													...
													if ($TeamInfo['Captain'] == $Row['Number']) {
														$strTemp = $strTemp . " (C)";
													}
													if ($TeamInfo['Assistant1'] == $Row['Number']) {
														$strTemp = $strTemp . " (A)";
													}
					...
					<div style="overflow-x:auto;">
						<table class="tablesorter STHSPHPTeam_GoaliesRosterTable">
							<thead>
								<tr>
					...
					<div style="overflow-x:auto;">
						<table class="tablesorter STHSPHPTeam_CoachesTable">
							<thead>
								<tr>
				...
				<div class="tabmain<?php if ($SubMenu == 2) {
										echo " active";
									} ?>" id="tabmain2">
								...
								<tr>
									...
									if ($PlayerStatTeam != Null) {
										if ($PlayerStatTeam['SumOfGP'] > 0) {
											...
											echo "<td>";
											if ($GoalieStatTeam <> Null) {
												echo Floor($GoalieStatTeam['SumOfSecondPlay'] / 60);
											};
											echo "</td>";
				...
				<div class="tabmain<?php if ($SubMenu == 3) {
										echo " active";
									} ?>" id="tabmain3">
					<?php
					$Team = (int) 0;
					...
					<div id="MainDiv" style="overflow-x:auto;">
						<div id="ReQueryDiv" style="display:<?php if ($Team > 0) {
																echo "none";
															} ?>">
						</div>
						...
						<table class="tablesorter STHSPHPTeamSalaryCapDetail_Table">
							...
							$AverageCap7 = (int) 0;
							$AverageCount = (int) 0;
							$AverageTotalCap1 = (int) 0;
							$AverageTotalCap2 = (int) 0;
							$AverageTotalCap3 = (int) 0;
							$AverageTotalCap4 = (int) 0;
							$AverageTotalCap5 = (int) 0;
							$AverageTotalCap6 = (int) 0;
							$AverageTotalCap7 = (int) 0;
							$AverageTotalCount = (int) 0;
								...
								while ($Row = $PlayerSalaryCap->fetchArray()) {
									if ($Row['PosD'] == "True" and $FoundD == False) {
										if ($AverageCount > 0) {
											...
											if ($SalaryCap > 0) {
												echo "<th>" . number_Format(($AverageCap1 / $SalaryCap) * 100, 2) . "%</th>";
											} else {
												echo "<th>N/A</th>";
											}
									...
									if ($Row['CanPlayPro'] == "True" and $Row['CanPlayFarm'] == "True") {
										echo "TW ";
									}
									echo "</td>";
									echo "<td>" . $Row['Contract'] . "</td>";
									if ($SalaryCap > 0) {
										echo "<td>" . number_Format(($Row['SalaryCap'] / $SalaryCap) * 100, 2) . "%</td>";
									} else {
										echo "<td>N/A</td>";
									}
									for ($i = 1; $i <= 7; $i = $i + 1) {
							...
							if ($SalaryCap > 0) {
								if ($AverageTotalCap1 / $SalaryCap > 1) {
									echo "<th style=\"background-color:#f44336;color:#000;\">" . number_Format(($AverageTotalCap1 / $SalaryCap) * 100, 2) . "%</th>";
								} elseif ($AverageTotalCap1 / $SalaryCap > 0.95) {
									echo "<th style=\"background-color:#FFA500;color:#000;\">" . number_Format(($AverageTotalCap1 / $SalaryCap) * 100, 2) . "%</th>";
								} elseif ($AverageTotalCap1 / $SalaryCap > 0.90) {
									echo "<th style=\"background-color:#FFFF00;color:#000;\">" . number_Format(($AverageTotalCap1 / $SalaryCap) * 100, 2) . "%</th>";
								} else {
									echo "<th style=\"background-color:#00ff00;color:#000;\">" . number_Format(($AverageTotalCap1 / $SalaryCap) * 100, 2) . "%</th>";
								}
							} else {
								echo "<th>N/A</th>";
							}
			...
			<div class=\"STHSPHPPlayerJerseyPlayerNumber\">" . $Row['Jersey'] . "</div>
					...
					<table class="STHSPHPTeamStat_Table">
						...
						<tr>
							...
							<th class="STHSW140"><?php echo $TeamLang['Defense']; ?></th>
							<th class="STHSW140"></th>
							<th class="STHSW25" style="display:none;"><?php # echo $TeamLang['TimePCT']; 
																		?></th>
							<th class="STHSW25" style="display:none;"><?php # echo $TeamLang['PHY']; 
																		?></th>
							<th class="STHSW25" style="display:none;"><?php # echo $TeamLang['DF']; 
																		?></th>
							<th class="STHSW25" style="display:none;"><?php # echo $TeamLang['OF']; 
																		?></th>
						</tr>
						<?php if ($TeamLines != Null) {
							echo "<tr>";
		...
		<div class=\"ContainerSTHSPHPPlayerJerseyTeamImage\">
			...
			<div class=\"STHSPHPPlayerJerseyPlayerNumber\">" . $Row['Jersey'] . "</div>
					...
					<table class="STHSPHPTeamStat_Table" <?php if ($LeagueWebClient != Null) {
																if ($LeagueWebClient['ProCustomOTLines'] == "False") {
				...
				<div class="tabmain<?php if ($SubMenu == 5) {
										echo " active";
									} ?>" id="tabmain5">
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="3"></th>
							<th colspan="10"><?php echo $TeamLang['TotalForPlayers']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25"><?php echo $GeneralStatLang['GamePlayed']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Points']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Streak']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Goals']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Assists']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Points']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['ShotsFor']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['ShotsAgainst']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['ShotsBlock']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['PenaltyMinutes']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Hits']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['EmptyNetGoals']; ?></th>
							<th class="STHSW25"><?php echo $GeneralStatLang['Shutouts']; ?></th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="<?php if ($LeagueGeneral != Null) {
												if ($LeagueGeneral['PointSystemSO'] == "True") {
													echo "9";
												}
											} else {
												echo "8";
											} ?>"><?php echo $TeamLang['AllGames']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25">GP</th>
							<th class="STHSW25">W</th>
							<th class="STHSW25">L</th>
							<th class="STHSW25">OTW</th>
							<th class="STHSW25">OTL</th>
							<?php if ($LeagueGeneral != Null) {
								if ($LeagueGeneral['PointSystemSO'] == "True") {
									echo "<th class=\"STHSW25\">SOW</th><th class=\"STHSW25\">SOL</th>";
								} else {
									echo "<th class=\"STHSW25\">T</th>";
								}
							} ?>
							<th class="STHSW25">GF</th>
							<th class="STHSW25">GA</th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
							echo "<td>" . $TeamStat['GP'] . "</td>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="<?php if ($LeagueGeneral != Null) {
												...
												echo "8";
											} ?>"><?php echo $TeamLang['HomeGames']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25">GP</th>
							<th class="STHSW25">W</th>
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="<?php if ($LeagueGeneral != Null) {
												...
												echo "8";
											} ?>"><?php echo $TeamLang['VisitorGames']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25">GP</th>
							<th class="STHSW25">W</th>
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th class="STHSW25"><?php echo $TeamLang['PowerPlayAttemps']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PowerPlayGoals']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PowerPlayPCT']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PenaltyKillAttemps']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PenaltyKillGoalsAgainst']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PenaltyKillPCT']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['PenaltyKillPCTGoalsFor']; ?></th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th class="STHSW25"><?php echo $TeamLang['Shots1Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Shots2Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Shots3Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Shots4Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Goals1Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Goals2Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Goals3Period']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['Goals4Period']; ?>
							</th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="9"><?php echo $TeamLang['FaceOffs']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25"><?php echo $TeamLang['WonOffensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['TotalOffensif']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['WonOffensifPCT']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['WonDefensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['TotalDefensif']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['WonDefensifPCT']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['WonNeutralZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['TotalNeutral']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['WonNeutralPCT']; ?></th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
							...
							echo "<td>";
							if ($TeamStat['FaceOffTotalOffensifZone'] > 0) {
								echo number_Format($TeamStat['FaceOffWonOffensifZone'] / $TeamStat['FaceOffTotalOffensifZone'] * 100, 2) . "%";
							} else {
								echo "0.00%";
							}
							echo "</td>";
							...
							echo "<td>";
							if ($TeamStat['FaceOffTotalDefensifZone'] > 0) {
								echo number_Format($TeamStat['FaceOffWonDefensifZone'] / $TeamStat['FaceOffTotalDefensifZone'] * 100, 2) . "%";
							} else {
								echo "0.00%";
							}
							echo "</td>";
							...
							echo "<td>";
							if ($TeamStat['FaceOffTotalNeutralZone'] > 0) {
								echo number_Format($TeamStat['FaceOffWonNeutralZone'] / $TeamStat['FaceOffTotalNeutralZone'] * 100, 2) . "%";
							} else {
								echo "0.00%";
							}
							echo "</td>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="6"><?php echo $TeamLang['PuckTime']; ?></th>
						</tr>
						<tr>
							<th class="STHSW25"><?php echo $TeamLang['InOffensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['ControlInOffensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['InDefensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['ControlInDefensifZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['InNeutralZone']; ?></th>
							<th class="STHSW25"><?php echo $TeamLang['ControlInNeutralZone']; ?></th>
						</tr>
						<?php if ($TeamStat != Null) {
							echo "<tr>";
				...
				<div class="tabmain<?php if ($SubMenu == 6) {
										echo " active";
									} ?>" id="tabmain6">
					<div class="tablesorter_ColumnSelectorWrapper">
					...
					<div style="overflow-x:auto;">
						<table class="tablesorter STHSPHPTeam_ScheduleTable">
							<thead>
								<tr>
				...
				<div class="tabmain<?php if ($SubMenu == 7) {
										echo " active";
									} ?>" id="tabmain7">
					<br />
					<!-- <table class="STHSPHPTeamStat_Table">
<tr>
<th colspan="6"><?php echo $TeamLang['ArenaCapacityTicketPriceAttendance']; ?></th>
</tr>
<tr>
<th class="STHSW200"></th>
<th class="STHSW100"><?php echo $TeamLang['Level']; ?> 1</th>
<th class="STHSW100"><?php echo $TeamLang['Level']; ?> 2</th>
<th class="STHSW100"><?php echo $TeamLang['Level']; ?> 3</th>
<th class="STHSW100"><?php echo $TeamLang['Level']; ?> 4</th>
<th class="STHSW100"><?php echo $TeamLang['Luxury']; ?></th>
</tr>
<?php
if ($TeamFinance != Null) {
	...
	if ($TeamStat['HomeGP'] > 0) {
		echo "<tr><th>" . $TeamLang['Attendance'] . "</th><td>" . number_Format($TeamFinance['AttendanceL1'], 0) . "</td><td>" . number_Format($TeamFinance['AttendanceL2'], 0) . "</td><td>" . number_Format($TeamFinance['AttendanceL3'], 0) . "</td><td>" . number_Format($TeamFinance['AttendanceL4'], 0) . "</td><td>" . number_Format($TeamFinance['AttendanceLuxury'], 0) . "</td></tr>\n";
	} else {
		echo "<tr><th>" . $TeamLang['Attendance'] . "</th><td>0.00%</td><td>0.00%</td><td>0.00%</td><td>0.00%</td><td>0.00%</td></tr>\n";
	}
	echo "<tr><th>Attendance PCT</th>";
	echo "<td>";
	if ($TeamFinance['ArenaCapacityL1'] > 0 and $TeamStat['HomeGP'] > 0) {
		echo number_format(($TeamFinance['AttendanceL1'] / ($TeamFinance['ArenaCapacityL1'] * $TeamStat['HomeGP'])) * 100, 2) . "%";
	} else {
		echo "0.00%";
	}
	echo "</td>";
	echo "<td>";
	if ($TeamFinance['ArenaCapacityL2'] > 0 and $TeamStat['HomeGP'] > 0) {
		echo number_format(($TeamFinance['AttendanceL2'] / ($TeamFinance['ArenaCapacityL2'] * $TeamStat['HomeGP'])) * 100, 2) . "%";
	} else {
		echo "0.00%";
	}
	echo "</td>";
	echo "<td>";
	if ($TeamFinance['ArenaCapacityL3'] > 0 and $TeamStat['HomeGP'] > 0) {
		echo number_format(($TeamFinance['AttendanceL3'] / ($TeamFinance['ArenaCapacityL3'] * $TeamStat['HomeGP'])) * 100, 2) . "%";
	} else {
		echo "0.00%";
	}
	echo "</td>";
	echo "<td>";
	if ($TeamFinance['ArenaCapacityL4'] > 0 and $TeamStat['HomeGP'] > 0) {
		echo number_format(($TeamFinance['AttendanceL4'] / ($TeamFinance['ArenaCapacityL4'] * $TeamStat['HomeGP'])) * 100, 2) . "%";
	} else {
		echo "0.00%";
	}
	echo "</td>";
	echo "<td>";
	if ($TeamFinance['ArenaCapacityLuxury'] > 0 and $TeamStat['HomeGP'] > 0) {
		echo number_format(($TeamFinance['AttendanceLuxury'] / ($TeamFinance['ArenaCapacityLuxury'] * $TeamStat['HomeGP'])) * 100, 2) . "%";
	} else {
		echo "0.00%";
	}
	echo "</td></tr>";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="6"><?php echo $TeamLang['Income']; ?>
							</th>
						</tr>
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['HomeGamesLeft']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['AverageAttendancePCT']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['AverageIncomeperGame']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['YeartoDateRevenue']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['ArenaCapacity']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['TeamPopularity']; ?>
							</th>
						</tr>
						<?php
						if ($TeamFinance != Null) {
							...
							if ($TeamFinance['ScheduleHomeGameInAYear'] > 0) {
								echo "<tr><td>" . ($TeamFinance['ScheduleHomeGameInAYear'] - $TeamStat['HomeGP']) . "</td>\n";
							} else {
								echo "<td>" . (($TeamFinance['ScheduleGameInAYear'] / 2) - $TeamStat['HomeGP']) . "</td>\n";
							}
							if ($TeamStat['HomeGP'] > 0) {
								echo "<td>" . Round($TeamFinance['TotalAttendance'] / $TeamStat['HomeGP']) . " - ";
								echo number_Format(($TeamFinance['TotalAttendance'] / ($TotalArenaCapacity * $TeamStat['HomeGP'])) * 100, 2) . "%</td>\n";
							} else {
								echo "<td>0 - 0.00%</td>";
							}
							if ($TeamStat['HomeGP'] > 0) {
								echo "<td>" . number_format($TeamFinance['TotalIncome'] / $TeamStat['HomeGP'], 0) . "$</td>";
							} else {
								echo "<td>0$</td>";
							}
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="5"><?php echo $TeamLang['Expenses']; ?></th>
						</tr>
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['YearToDateExpenses']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['PlayersTotalSalaries']; ?>
							</th>
							<th class="STHSW140"><?php echo $TeamLang['PlayersTotalAverageSalaries']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['CoachesSalaries']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['SpecialSalaryCapValue']; ?></th>
						</tr>
						<?php
						if ($TeamFinance != Null) {
							...
							if (Count($CoachInfo) == 1) {
								echo number_Format($CoachInfo['Salary'], 0) . "$";
							};
							echo "0$</td>\n";
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['SalaryCapPerDays']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['SalaryCapToDate']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['LuxuryTaxeTotal']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['PlayerInSalaryCap']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['PlayerOutofSalaryCap']; ?></th>
						</tr>
						<?php
						if ($TeamFinance != Null) {
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="4"><?php echo $TeamLang['Estimate']; ?></th>
						</tr>
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['EstimatedSeasonRevenue']; ?></th>
							<th class="STHSW140"><?php echo $TeamLang['RemainingSeasonDays']; ?>
							</th>
							<th class="STHSW140"><?php echo $TeamLang['ExpensesPerDays']; ?></th>
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th colspan="3"><?php echo $TeamLang['TeamTotalEstime']; ?></th>
						</tr>
						<tr>
							<th class="STHSW140"><?php echo $TeamLang['EstimatedSeasonExpenses']; ?></th>
				...
				<div class="tabmain<?php if ($SubMenu == 8) {
										echo " active";
									} ?>" id="tabmain8">
					<h3 class="STHSTeamProspect_DraftPick"><?php echo $TeamLang['DepthChart']; ?></h3>
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th style="width:33%;"><?php echo $TeamLang['LeftWing']; ?></th>
							<th style="width:33%;"><?php echo $TeamLang['Center']; ?></th>
							<th style="width:33%;"><?php echo $TeamLang['RightWing']; ?></th>
						</tr>
						<tr>
							<td class="STHSAlignTop">
								<table class="STHSPHPTeamStatDepthChart_Table">
									...
									if (empty($PlayerDepthChartC) == false) {
							...
							<td class="STHSAlignTop">
								<table class="STHSPHPTeamStatDepthChart_Table">
									<?php
									if (empty($PlayerDepthChartLW) == false) {
							...
							<td class="STHSAlignTop">
								<table class="STHSPHPTeamStatDepthChart_Table">
									<?php
									if (empty($PlayerDepthChartRW) == false) {
					...
					<table class="STHSPHPTeamStat_Table">
						<tr>
							<th style="width:33%;"><?php echo $TeamLang['Defense']; ?> #1</th>
							<th style="width:33%;"><?php echo $TeamLang['Defense']; ?> #2</th>
							<th style="width:33%;"><?php echo $TeamLang['Goalie']; ?></th>
						</tr>
						<tr>
							<td class="STHSAlignTop">
								<table class="STHSPHPTeamStatDepthChart_Table">
									...
									$NumOfD = (int) 0;
									$Count = (int) 0;
									if (empty($PlayerDepthChart) == false) {
									...
									if (empty($PlayerDepthChartD) == false) {
										while ($Row = $PlayerDepthChartD->fetchArray()) {
											if ($Row['PosD'] == "True") {
												...
												$Count++;
												if ($NumOfD == $Count) {
													echo "</table></td><td class=\"STHSAlignTop\"><table class=\"STHSPHPTeamStatDepthChart_Table\">";
												}
											}
										}
									}
							...
							<td class="STHSAlignTop">
								<table class="STHSPHPTeamStatDepthChart_Table">
									<?php
									if (empty($GoalieDepthChart) == false) {
					...
					<div style="overflow-x:auto;">
						<table class="STHSPHPTeamStat_Table">
							<tr>
								<th class="STHSW140"><?php echo $TeamLang['Year']; ?></th>
								<?php
								if (empty($TeamDraftPick) == false) {
									...
									while ($row = $TeamDraftPick->fetchArray()) {
										if ($CurrentYear <> $row['Year']) {
											if ($CurrentRound < $DraftPickByYear and $CurrentRound > 0) {
												for ($x = $CurrentRound; $x < $DraftPickByYear; $x++) {
													echo "<td></td>";
												}
												echo "</tr>\n"; /* Code to Create Empty TD if team doesn't have last round Pick */
											} elseif ($CurrentYear > 0) {
										...
										echo "<img src=\"./images/Pro-team/" . $row['FromTeam'] . ".png\" alt=\"\" class=\"STHSPHPDraftPickTeamImage \" /> ";
										/*if ($row['FromTeamThemeID'] > 0) {
				  echo "<img src=\"./images/pro-team/" . $row['FromTeamThemeID'] . ".png\" alt=\"\" class=\"STHSPHPDraftPickTeamImage \" /> ";
			  } else {
				  echo $row['FromTeamAbbre'] . " ";
			  }*/
										if ($row['ConditionalTrade'] != "") {
											echo "[CON: " . $row['ConditionalTrade'] . "]";
										}
									}
									if ($CurrentRound < $DraftPickByYear and $CurrentRound > 0) {
										for ($x = $CurrentRound; $x < $DraftPickByYear; $x++) {
										...
										echo "</td></tr></table>";
									} /* Code to Create Empty TD if team doesn't have last round Pick for the last year and to close the table*/
								} else {
									echo "</tr></table>";
								}
								?>
				...
				<div class="tabmain<?php if ($SubMenu == 13) {
										echo " active";
									} ?>" id="tabmain13">
					<br />
				...
				<div class="tabmain<?php if ($SubMenu == 9) {
										echo " active";
									} ?>" id="tabmain9">
					<br />
					<?php
					if (empty($TeamLog) == false) {
						while ($row = $TeamLog->fetchArray()) {
				...
				<div class="tabmain<?php if ($SubMenu == 10) {
										echo " active";
									} ?>" id="tabmain10">
					<br />
					<?php
					if (empty($TeamTransaction) == false) {
						while ($row = $TeamTransaction->fetchArray()) {
							if ($row['Color'] == "") {
								echo "[" . $row['DateTime'] . "] " . $row['Text'] . "<br />\n"; /* The \n is for a new line in the HTML Code */
							} else {
				...
				<div class="tabmain<?php if ($SubMenu == 12) {
										echo " active";
									} ?>" id="tabmain12">
					<?php if (isset($PerformanceMonitorStart)) {
						echo "<script>console.log(\"STHS 12 Page PHP Performance : " . (microtime(true) - $PerformanceMonitorStart) . "\"); </script>";
					} ?>
					<br />
					...
					if (empty($TeamInjurySuspension) == false) {
						while ($Row = $TeamInjurySuspension->fetchArray()) {
							if ($Row['ConditionDecimal'] <= 95) {
								$booFound = True;
								if ($Row['Status1'] >= 2) {
									$sngInjury = (95 - $Row['Condition']) / $LeagueGeneral['ProInjuryRecoverySpeed'];
								} else {
									$sngInjury = (95 - $Row['Condition']) / $LeagueGeneral['FarmInjuryRecoverySpeed'];
								}
				...
				<div class="tabmain<?php if ($SubMenu == 11) {
					...
					<table class="tablesorter STHSPHPTeam_TeamCareerStat">
						<thead>
							<tr>
								<th class="sorter-false"></th>
								<th class="sorter-false" colspan="11"><?php echo $TeamStatLang['Overall']; ?></th>
								<th class="sorter-false" colspan="11"><?php echo $TeamStatLang['Home']; ?></th>
								<th class="sorter-false" colspan="11"><?php echo $TeamStatLang['Visitor']; ?></th>
								<th class="sorter-false" colspan="41"></th>
							</tr>
							<tr>
						...
						<tbody>
							...
							if ($TeamCareerSumSeasonOnly != Null) {
								...
								if (empty($TeamCareerSeason) == false) {
									while ($row = $TeamCareerSeason->fetchArray()) {
										...
										echo "<td>";
										if ($row['PPAttemp'] > 0) {
											echo number_Format($row['PPGoal'] / $row['PPAttemp'] * 100, 2) . "%";
										} else {
											echo "0.00%";
										}
										echo "</td>";
										...
										echo "<td>";
										if ($row['PKAttemp'] > 0) {
											echo number_Format(($row['PKAttemp'] - $row['PKGoalGA']) / $row['PKAttemp'] * 100, 2) . "%";
										} else {
											echo "0.00%";
										}
										echo "</td>";
										...
										echo "<td>";
										if ($row['FaceOffTotalOffensifZone'] > 0) {
											echo number_Format($row['FaceOffWonOffensifZone'] / $row['FaceOffTotalOffensifZone'] * 100, 2) . "%";
										} else {
											echo "0.00%";
										}
										echo "</td>";
										...
										echo "<td>";
										if ($row['FaceOffTotalDefensifZone'] > 0) {
											echo number_Format($row['FaceOffWonDefensifZone'] / $row['FaceOffTotalDefensifZone'] * 100, 2) . "%";
										} else {
											echo "0.00%";
										}
										echo "</td>";
										...
										echo "<td>";
										if ($row['FaceOffTotalNeutralZone'] > 0) {
											echo number_Format($row['FaceOffWonNeutralZone'] / $row['FaceOffTotalNeutralZone'] * 100, 2) . "%";
										} else {
											echo "0.00%";
										}
										echo "</td>";
								...
								if ($TeamCareerSumSeasonOnly['SumOfGP'] > 0) {
									...
									echo "<td>";
									if ($TeamCareerSumSeasonOnly['SumOfPPAttemp'] > 0) {
										echo number_Format($TeamCareerSumSeasonOnly['SumOfPPGoal'] / $TeamCareerSumSeasonOnly['SumOfPPAttemp'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumSeasonOnly['SumOfPKAttemp'] > 0) {
										echo number_Format(($TeamCareerSumSeasonOnly['SumOfPKAttemp'] - $TeamCareerSumSeasonOnly['SumOfPKGoalGA']) / $TeamCareerSumSeasonOnly['SumOfPKAttemp'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumSeasonOnly['SumOfFaceOffTotalOffensifZone'] > 0) {
										echo number_Format($TeamCareerSumSeasonOnly['SumOfFaceOffWonOffensifZone'] / $TeamCareerSumSeasonOnly['SumOfFaceOffTotalOffensifZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumSeasonOnly['SumOfFaceOffTotalDefensifZone'] > 0) {
										echo number_Format($TeamCareerSumSeasonOnly['SumOfFaceOffWonDefensifZone'] / $TeamCareerSumSeasonOnly['SumOfFaceOffTotalDefensifZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumSeasonOnly['SumOfFaceOffTotalNeutralZone'] > 0) {
										echo number_Format($TeamCareerSumSeasonOnly['SumOfFaceOffWonNeutralZone'] / $TeamCareerSumSeasonOnly['SumOfFaceOffTotalNeutralZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
								...
								if (empty($TeamCareerPlayoff) == false) {
									while ($row = $TeamCareerPlayoff->fetchArray()) {
								...
								if ($TeamCareerSumPlayoffOnly['SumOfGP'] > 0) {
									...
									echo "<td>";
									if ($TeamCareerSumPlayoffOnly['SumOfPPAttemp'] > 0) {
										echo number_Format($TeamCareerSumPlayoffOnly['SumOfPPGoal'] / $TeamCareerSumPlayoffOnly['SumOfPPAttemp'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumPlayoffOnly['SumOfPKAttemp'] > 0) {
										echo number_Format(($TeamCareerSumPlayoffOnly['SumOfPKAttemp'] - $TeamCareerSumPlayoffOnly['SumOfPKGoalGA']) / $TeamCareerSumPlayoffOnly['SumOfPKAttemp'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumPlayoffOnly['SumOfFaceOffTotalOffensifZone'] > 0) {
										echo number_Format($TeamCareerSumPlayoffOnly['SumOfFaceOffWonOffensifZone'] / $TeamCareerSumPlayoffOnly['SumOfFaceOffTotalOffensifZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumPlayoffOnly['SumOfFaceOffTotalDefensifZone'] > 0) {
										echo number_Format($TeamCareerSumPlayoffOnly['SumOfFaceOffWonDefensifZone'] / $TeamCareerSumPlayoffOnly['SumOfFaceOffTotalDefensifZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
									...
									echo "<td>";
									if ($TeamCareerSumPlayoffOnly['SumOfFaceOffTotalNeutralZone'] > 0) {
										echo number_Format($TeamCareerSumPlayoffOnly['SumOfFaceOffWonNeutralZone'] / $TeamCareerSumPlayoffOnly['SumOfFaceOffTotalNeutralZone'] * 100, 2) . "%";
									} else {
										echo "0.00%";
									}
									echo "</td>";
