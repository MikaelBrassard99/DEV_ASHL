		...
		<div id="rostereditor">
			<div class="pagewrapper pagewrapperrostereditor"><?php 
				...
				if($showHeader){
					...
					$teamname = (!empty($row)) ? $row["FullTeamName"] . " - " : "";
					?>
					<h1><?= $teamname ?>Roster Editor - <a href="WebClientLines.php?League=Pro&TeamID=<?=$teamid;?>">Pro Line Editor</a> - <a href="WebClientLines.php?League=Farm&TeamID=<?=$teamid;?>">Farm Line Editor</a> - <a href="WebClientTeam.php">Web Client Team</a></h1><?php
				}
