...
function PrintGames($Row, $TodayGamesLang)
{
	...
	echo "<table class=\"STHSTodayGame_GameTitle\"><tr style=\"display:block;\"><td class=\"STHSTodayGame_GameNumber\"><h3>";
	...
	echo "</h2></td><td class=\"STHSTodayGame_Boxscore\"><h3><a href=\"" . $Row['Link'] . "\">" . $TodayGamesLang['BoxScore'] .  "</a></h3></td>";
	echo "</tr></table>";
	echo "<table class=\"STHSTodayGame_GameData\"><tr>";
	echo "<td class=\"STHSTodayGame_TeamName\"><h2>";
	echo "<img src=\"./images/" . (substr($Row['GameNumber'], 0, 3) == "Pro" ? substr($Row['GameNumber'], 0, 3) : substr($Row['GameNumber'], 0, 4)) . "-team/" . $Row['VisitorTeamNumber'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";

	/*if ($Row['VisitorTeamThemeID'] > 0) {
		echo "<img src=\"./images/pro-team/" . $Row['VisitorTeamThemeID'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
	}*/
	echo $Row['VisitorTeam'] . "</h3></td>";
	echo "<td class=\"STHSTodayGame_TeamScore\"><h2>";
	...
	echo "<img src=\"./images/" . (substr($Row['GameNumber'], 0, 3) == "Pro" ? substr($Row['GameNumber'], 0, 3) : substr($Row['GameNumber'], 0, 4)) . "-team/" . $Row['HomeTeamNumber'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";

	/*if ($Row['HomeTeamThemeID'] > 0) {
		echo "<img src=\"./images/pro-team/" . $Row['HomeTeam'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
	}*/
	...
	<tr style=\"display:block;\">
		<td style=\"width:33%\">
			<img src=\"./images/Pro-team/Star1.png\"/ style=\"width:100%\">
		</td>
		<td style=\"\">
			<img src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer(strtolower(str_replace(" ", "-", (substr($Row['Star1'], 0, -6))))) . "&width=136&height=100\" style=\"width:100%; height:100%; border-radius: 40%;\"/>
		</td>
		<td style=\"width:33%\">" . $Row['Star1'] . "</td>
	</tr>";
	echo "
	<tr style=\"display:block;\">
		<td style=\"width:33%\">
			<img src=\"./images/Pro-team/Star2.png\"/ style=\"width:100%\">
		</td>
		<td style=\"width:33%\">
			<img src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer(strtolower(str_replace(" ", "-", (substr($Row['Star2'], 0, -6))))) . "&width=136&height=100\" style=\"width:100%; height:100%; border-radius: 40%;\"/>
		</td>
		<td style=\"width:33%\">" . $Row['Star2'] . "</td>
	</tr>";
	echo "
	<tr style=\"display:block;\">
		<td style=\"width:33%\">
			<img src=\"./images/Pro-team/Star3.png\"/ style=\"width:100%\">
		</td>
		<td style=\"width:33%\">
			<img src=\"https://tsnimages.tsn.ca/ImageProvider/PlayerHeadshot?seoId=" . createPickturePlayer(strtolower(str_replace(" ", "-", (substr($Row['Star3'], 0, -6))))) . "&width=136&height=100\" style=\"width:100%; height:100%; border-radius: 40%;\"/>
		</td>
		<td style=\"width:33%\">" . $Row['Star3'] . "</td>
	</tr>
	</table>";
	...
	<div style="width:100%;margin:auto;">
		<table class="STHSTableFullW">
			...
			<table class="STHSTodayGame_MainTable">
				...
				if ($LoopCount == 0) {
					echo "<h3 class=\"STHSCenter\">" . $TodayGamesLang['NoGameToday'] . "</h3>";
				}
				?>
				<br />
					...
					<tbody>
						...
						if (empty($Schedule) == false) {
							while ($row = $Schedule->fetchArray()) {
								...
								echo "<img src=\"./images/" . $row['Type'] . "-team/" . $row['VisitorTeam'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
								/*if ($row['VisitorTeamThemeID'] > 0) {
									echo "<img src=\"./images/pro-team/" . $row['VisitorTeamThemeID'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
								}*/
								...
								echo "</td><td>";
								echo "<img src=\"./images/" . $row['Type'] . "-team/" . $row['HomeTeam'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
								/*if ($row['HomeTeamThemeID'] > 0) {
									echo "<img src=\"./images/pro-team/" . $row['HomeTeamThemeID'] . ".png\" alt=\"\" class=\"STHSPHPTodayGameTeamImage\" />";
								}*/
