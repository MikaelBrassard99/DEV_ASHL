...
<body>
	<div class="container_slick">
		...
		if (empty($LatestScore) == false) {
			echo "<div class=\"MagicScroll \" style=\"margin: 0;
			\">";
			echo "<div style=\"\"><table class=\"next_day_boxscore\"><tr><td>Today</td></tr></table></div>";
			while ($row = $LatestScore->fetchArray(SQLITE3_BOTH)) {
				echo "<div id=\"box_score\" ondblclick=\"navigateTo(" . $row['link'] . ")\"><table class=\"STHSIndex_GamesResult\"> ";
				echo "<tr><td style=\"width:24px;height:24px; align-items: center;\">";
				echo "<img src=\"./images/pro-team/" . $row['VisitorTeam'] . ".png\" alt=\"\" class=\"STHSPHPIndexTeamImage\" />";
				echo "</td><td>";
				echo $row['VisitorTeamAbbre'] . "</td><td class=\"STHSRight\">" . $row['VisitorScore'] . "</td></tr>";
				echo "<tr><td style=\"width:24px;height:24px; align-items: center;\">";
				echo "<img src=\"./images/pro-team/" . $row['HomeTeam'] . ".png\" alt=\"\" class=\"STHSPHPIndexTeamImage\" />";
				echo "</td><td>";
				echo $row['HomeTeamAbbre'] . "</td><td class=\"STHSRight\">" . $row['HomeScore'] . "</td></tr>";
				echo "</table>";
				echo "</div>";
			}
		}
		echo "<div style=\"\"><table class=\"next_day_boxscore\"><tr><td>Next<td></tr></table></div>";
		if (empty($Schedule) == false) {
			while ($row = $Schedule->fetchArray()) {
				echo "<div style=\"width:100%;\"><table class=\"STHSIndex_GamesResult\">";
